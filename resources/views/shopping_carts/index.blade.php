        ...
        <div class="row">
          <div class="col-xs-12 offset-xs-1 col-md-7 offset-md-0" id="div-nav">
            <ul class="nav navbar-nav" id="nav-f" >
              ...
              <li class="nav-item text-xs-center">
                <a href="{{url('/carrito')}}" class="nav-link" style="color: black"><img src="CelularesPeru/imagenes/mcarrito3.png"><strong> Carrito</strong><span><strong>
                {{$productsCount}}</strong>
                </span>
                </a>
              </li>
